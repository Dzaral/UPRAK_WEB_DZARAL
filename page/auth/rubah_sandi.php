            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="">
                        ...
                        <input type="text" name="pwlama" id="pwlama" class="newinp">
                    </div>
                    <div class="">
                        <label for="pwbaru">Password Baru</label>
                        <input type="text" name="pwbaru" id="pwbaru" class="newinp">
                    </div>
                    <div class="">
                        <label for="confirmpw">Konfirmasi Password</label>
                        <input type="text" name="confirmpw" id="confirmpw" class="newinp">
                    </div>

                    <button class="btn-info" id="btn-simpan">SIMPAN</button>
                </div>
                <!-- /.container-fluid -->
